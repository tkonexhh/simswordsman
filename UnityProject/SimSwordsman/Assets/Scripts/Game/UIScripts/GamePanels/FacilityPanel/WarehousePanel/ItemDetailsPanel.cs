...
namespace GameWish.Game
{
    ...
    public class ItemDetailsPanel : AbstractAnimPanel
    {
        ...
        private void GenerateItemName()
        {
            ...
            {
                case PropType.Arms:
                    strName += CommonUIMethod.GetTextNumber((int)((ArmsItem)m_CurInventoryItem).ClassID) + "阶";
                    break;
                case PropType.Armor:
                    strName += CommonUIMethod.GetTextNumber((int)((ArmorItem)m_CurInventoryItem).ClassID) + "阶";
                    break;
            }
