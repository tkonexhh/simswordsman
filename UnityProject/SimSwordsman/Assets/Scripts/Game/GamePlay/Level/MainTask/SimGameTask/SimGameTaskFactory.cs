        ...
        public static SimGameTask SpawnTask(int taskId, SimGameTaskType taskType, int subType,TaskState taskState)
        {
            ...
            switch (taskType)
            {
                case SimGameTaskType.Collect:
                    ...
                    task = new TaskCollectRes(taskId, SimGameTaskType.Collect, subType, m_MainTaskTableName, taskState, MainGameMgr.S.MainTaskMgr.OnTaskStateChanged);
                    break;
                case SimGameTaskType.Battle:
                    task = new TaskBattle(taskId, SimGameTaskType.Battle, subType, m_MainTaskTableName, taskState, MainGameMgr.S.MainTaskMgr.OnTaskStateChanged);
                    break;
            }
