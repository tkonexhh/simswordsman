...
{
    public class SignSystemMgr : TSingleton<SignSystemMgr>
    {
        ...
        public class SignState
        {
            ...
            public void Reset()
            {
                //Log.e("SignState : Reset");
                m_SignAbleIndex = 0;
                m_LastSignIndex = -1;
                //Save();
                PlayerPrefs.SetInt(m_LastSignDayIndexKey, -1);
                PlayerPrefs.SetString(m_LastSignDayKey, "");
            }

            public bool Sign()
            {
                //Log.e("SignState : Sign");
                if (!isSignAble)
                {
                    return false;
                }
            ...
            private void Load()
            {
                ...
                //Log.e("SignState : Load" + timeString + "***" + m_LastSignIndex);
