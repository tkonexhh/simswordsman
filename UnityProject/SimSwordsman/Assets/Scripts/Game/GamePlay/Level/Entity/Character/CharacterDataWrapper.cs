...
namespace GameWish.Game
{
    ...
    public class CharacterItem : IComparable
    {
        ...
        public int stage = 1; // ��λ
        public int curExp = 0; // ��ǰ����
        public string startTime; // ����ʱ��
        public CharacterQuality quality; // Ʒ��
        public CharacterStateID characterStateId = CharacterStateID.None; // ��Ϊ
        public float atkValue; // ����ֵ
        public string name; // ����
        public string desc; // ��ϸ��Ϣ
