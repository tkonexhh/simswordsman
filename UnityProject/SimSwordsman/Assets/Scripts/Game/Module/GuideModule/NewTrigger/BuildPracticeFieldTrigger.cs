...
{
	public class BuildPracticeFieldTrigger : ITrigger
	{
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnGuideUnlockPracticeField, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnGuideUnlockPracticeField, OnEventListener);
