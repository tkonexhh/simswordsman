...
{
	public class RecruitmentSystem_ClickGetCharacterTrigger : ITrigger
    {
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnRecruitmentSystem_ClickGetCharacterTrigger, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnRecruitmentSystem_ClickGetCharacterTrigger, OnEventListener);
