...
{
    public class TowerTrigger_FaildTrigger : ITrigger
    {
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnTowerTrigger_FaildTrigger, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnTowerTrigger_FaildTrigger, OnEventListener);
        }
    }
}