...
{
	public class BuildForgehouseTrigger : ITrigger
	{
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnGuideUnlockForgeHouse, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnGuideUnlockForgeHouse, OnEventListener);
