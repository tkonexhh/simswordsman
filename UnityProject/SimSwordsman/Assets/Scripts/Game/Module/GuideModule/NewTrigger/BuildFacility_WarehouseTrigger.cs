...
{
	public class BuildFacility_WarehouseTrigger : ITrigger
	{
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnGuideBuildWarehouse, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnGuideBuildWarehouse, OnEventListener);
