...
{
	public class SignInSystem_ClickSignReceiveBtnTrigger : ITrigger
    {
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnSignInSystem_ClickSignReceiveBtnTrigger, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnSignInSystem_ClickSignReceiveBtnTrigger, OnEventListener);
