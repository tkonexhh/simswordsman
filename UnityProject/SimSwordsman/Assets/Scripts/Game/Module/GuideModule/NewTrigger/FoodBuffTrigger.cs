...
{
	public class FoodBuffTrigger : ITrigger
	{
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnCuideKitchenFirstLvUp, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnCuideKitchenFirstLvUp, OnEventListener);
