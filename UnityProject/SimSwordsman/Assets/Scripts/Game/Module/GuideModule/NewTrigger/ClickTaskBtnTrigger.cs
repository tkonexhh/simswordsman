...
{
	public class ClickTaskBtnTrigger : ITrigger
	{
        ...
        {
            m_Listener = l;
            EventSystem.S.Register(EventID.OnGuideClickTaskTrigger, OnEventListener);
        }
        ...
        public void Stop()
        {
            m_CanStart = false;
            m_Listener = null;
            EventSystem.S.UnRegister(EventID.OnGuideClickTaskTrigger, OnEventListener);
